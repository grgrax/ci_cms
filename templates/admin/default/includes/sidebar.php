<div class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Manage Groups & Users<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?=base_url()?>group">Manage Group</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>user">Manage User</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                <h4>
                    <a href="#"><?php echo config_item('powered_by'); ?></a>
                </h4>
                <!-- /.nav-second-level -->
            </li>
        </ul>
