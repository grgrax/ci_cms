...
DROP DATABASE IF EXISTS `pra_oop`;
...
DROP TABLE IF EXISTS `tbl_blogs_comments`;
...
CREATE TABLE IF NOT EXISTS `tbl_permissions` (
  ...
  CONSTRAINT `fk_parent_permission_id` FOREIGN KEY (`parent_permission_id`) REFERENCES `tbl_permissions` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
